...
public class SecurityHelperForMockMvc {
	...
	/**
	 * Allows to get an access token for the given user in the context of a
	 * spring (unit) test using MockMVC.
	 *
	 * @param mvc      the MockMvc instance
	 * @param username the username
	 * @param password the password
	 * @return the <code>access_token</code> to be used in the
	 *         <code>Authorization</code> header
	 * @throws Exception if no token could be obtained.
	 */
	public static String obtainAccessToken(MockMvc mvc, String username,
