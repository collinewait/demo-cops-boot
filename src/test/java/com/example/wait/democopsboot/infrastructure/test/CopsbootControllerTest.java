...
/**
 * Custom annotation for all {@link org.springframework.stereotype.Controller
 * Controller} tests on the project. By using this single annotation, everything
 * is configured properly to test a controller:
 * <ul>
